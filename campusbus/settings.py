...
# Email backend for notifications (must be after imports and dotenv)
...
ASGI_APPLICATION = 'campusbus.asgi.application'

WSGI_APPLICATION = 'campusbus.wsgi.application'
...
# Set login URL for authentication redirects
